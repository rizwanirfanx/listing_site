...
class Payment
{
	...
	public static function setRightUrls($resData)
	{
		...
		public static function savePaymentManual($resData)
	{	
		if(array_key_exists('duration', $resData))
			$data = $resData['duration'];
		else
			$data = 1;
		
	    $random = Str::random(20);
		$respones = DB::table('payments')->insert([
        'payment_method_id' => $resData['payment_method_id'],
