 							    ...
 							    ?>
                                    <div class="card mb-2" style="width:100%;">
                                        ...
                                        <div class="card-footer bg-gray">
                                          <a href="{{ $postUrl }}" title="{{ $post->title }}"><i class="fa fa-eye"></i> View</a>
											...
											@if (in_array($pagePath, ['my-posts']) and isVerifiedPost($post) and $post->archived==0)
													<a class="confirm-action" href="{{ url('account/'.$pagePath.'/'.$post->id.'/offline') }}">
														<i class="icon-eye-off"></i> {{ t('Offline') }}
													</a>
											@endif
											@if (in_array($pagePath, ['archived']) and $post->user_id==$user->id and $post->archived==1)
                                                    <a class="confirm-action" href="{{ url('account/'.$pagePath.'/'.$post->id.'/repost') }}">
                                                        <i class="fa fa-recycle"></i> {{ t('Repost') }}
                                                    </a>
											@endif
                                                <a class=" delete-action" href="{{ url('account/'.$pagePath.'/'.$post->id.'/delete') }}">
                                                    <i class="fa fa-trash"></i> {{ t('Delete') }}
                                                </a>
...
<!-- This section is commented due to requirement-->
