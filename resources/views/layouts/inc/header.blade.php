			...
			<div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav ml-auto navbar-right">
					...
					@else
						...
						<li class="nav-item dropdown no-arrow">
							...
							<ul id="userMenuDropdown" class="dropdown-menu user-menu dropdown-menu-right shadow-sm">
								...
								<li class="dropdown-item"><a href="{{ url('account/my-wallet') }}"><i class="fas fa-wallet"></i> My Wallet </a></li>
					...
					<li class="nav-item postadd" >
						<a class="btn btn-block btn-border btn-post btn-add-listing" style="background:#ff0000" href="{{ $addListingUrl }}"{!! $addListingAttr !!}>
