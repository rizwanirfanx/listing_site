...
<head>
    ...
    <title>LaraClassified API Reference</title>
...
<div class="tocify-wrapper">
        <img src="https://laraclassified.bedigit.com/storage/app/default/logo-api.png" alt="logo" class="logo" style="padding-top: 10px;" width="230px"/>
...
<div class="page-wrapper">
    ...
    <div class="content">
        <h1>Introduction</h1>
<p>LaraClassified API specification and documentation.</p>
...
<script>
    var baseUrl = "https://pak.zecanto.co";
</script>
...
<form id="form-POSTapi-auth-login" data-method="POST" data-path="api/auth/login" data-authed="0" data-hasfiles="0" data-headers='{"Content-Type":"application\/json","Accept":"application\/json","Content-Language":"en","X-AppApiToken":"WjdjT1ZGUmZxTFB4aW43QUV6dURmZGRVY1FUVWhpcjM=","X-AppType":"docs"}' onsubmit="event.preventDefault(); executeTryOut('POSTapi-auth-login', this);">
<h3>
    Request&nbsp;&nbsp;&nbsp;
...
<pre><code class="language-bash">curl -X POST \
    ...
    -F "post_id=2" \
    -F "pictures[]=@/private/var/folders/r0/k0xbnx757k3fnz09_6g9rp6w0000gn/T/phpQx7uBR" </code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://laraclassified.bedigit.local/api/pictures"
);
...
<pre><code class="language-bash">curl -X POST \
    ...
    -F "captcha_key=quod" \
    -F "pictures[]=@/private/var/folders/r0/k0xbnx757k3fnz09_6g9rp6w0000gn/T/phpHzOLPB" </code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://laraclassified.bedigit.local/api/posts"
);
...
<pre><code class="language-bash">curl -X PUT \
    ...
    -F "package_id=2" \
    -F "payment_method_id=5" \
    -F "pictures[]=@/private/var/folders/r0/k0xbnx757k3fnz09_6g9rp6w0000gn/T/phpsWI7ic" </code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://laraclassified.bedigit.local/api/posts/ducimus"
);
...
<pre><code class="language-bash">curl -X DELETE \
    "https://laraclassified.bedigit.local/api/savedSearches/temporibus" \
    -H "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Content-Language: en" \
...
<pre><code class="language-bash">curl -X GET \
    -G "https://laraclassified.bedigit.local/api/settings/maiores" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Content-Language: en" \
    -H "X-AppApiToken: Uk1DSFlVUVhIRXpHbWt6d2pIZjlPTG15akRPN2tJTUs=" \
    -H "X-AppType: docs"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://laraclassified.bedigit.local/api/settings/maiores"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "https://laraclassified.bedigit.local/api/threads?filter=est" \
    -H "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Content-Language: en" \
...
<pre><code class="language-bash">curl -X GET \
    -G "https://laraclassified.bedigit.local/api/threads/ipsum" \
    -H "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Content-Language: en" \
    ...
    -H "X-AppType: docs"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://laraclassified.bedigit.local/api/threads/ipsum"
);
...
<pre><code class="language-bash">curl -X POST \
    ...
    -F "from_phone=aspernatur" \
    -F "body=Modi temporibus voluptas expedita voluptatibus voluptas veniam." \
    -F "post_id=2" \
    -F "captcha_key=alias" \
    -F "filename=@/private/var/folders/r0/k0xbnx757k3fnz09_6g9rp6w0000gn/T/phpCnYbMw" </code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://laraclassified.bedigit.local/api/threads"
);
...
$response = $client-&gt;post(
    ...
    [
        ...
        'multipart' =&gt; [
            ...
            [
                'name' =&gt; 'filename',
                'contents' =&gt; fopen('/private/var/folders/r0/k0xbnx757k3fnz09_6g9rp6w0000gn/T/phpCnYbMw', 'r')
            ],
        ],
    ]
);
...
<pre><code class="language-bash">curl -X PUT \
    "https://laraclassified.bedigit.local/api/threads/minus" \
    -H "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    -H "Content-Type: multipart/form-data" \
    -H "Accept: application/json" \
    -H "Content-Language: en" \
    ...
    -H "X-AppType: docs" \
    -F "body=Modi temporibus voluptas expedita voluptatibus voluptas veniam." \
    -F "filename=@/private/var/folders/r0/k0xbnx757k3fnz09_6g9rp6w0000gn/T/phpDgQFBq" </code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://laraclassified.bedigit.local/api/threads/minus"
);
...
$response = $client-&gt;put(
    ...
    [
        ...
        'multipart' =&gt; [
            ...
            [
                'name' =&gt; 'filename',
                'contents' =&gt; fopen('/private/var/folders/r0/k0xbnx757k3fnz09_6g9rp6w0000gn/T/phpDgQFBq', 'r')
            ],
        ],
    ]
);
...
<pre><code class="language-bash">curl -X DELETE \
    "https://laraclassified.bedigit.local/api/threads/possimus" \
    -H "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Content-Language: en" \
...
<pre><code class="language-bash">curl -X POST \
    "https://laraclassified.bedigit.local/api/threads/bulkUpdate/omnis?type=aut" \
    -H "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Content-Language: en" \
    ...
    -H "X-AppType: docs"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://laraclassified.bedigit.local/api/threads/bulkUpdate/omnis"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "https://laraclassified.bedigit.local/api/users/suscipit" \
    -H "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Content-Language: en" \
    ...
    -H "X-AppType: docs"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://laraclassified.bedigit.local/api/users/suscipit"
);
...
<pre><code class="language-bash">curl -X POST \
    ...
    -F "captcha_key=eligendi" \
    -F "photo=@/private/var/folders/r0/k0xbnx757k3fnz09_6g9rp6w0000gn/T/phpMfFSyZ" </code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://laraclassified.bedigit.local/api/users"
);
...
$response = $client-&gt;post(
    ...
    [
        ...
        'multipart' =&gt; [
            ...
            [
                'name' =&gt; 'photo',
                'contents' =&gt; fopen('/private/var/folders/r0/k0xbnx757k3fnz09_6g9rp6w0000gn/T/phpMfFSyZ', 'r')
            ],
        ],
    ]
);
...
<pre><code class="language-json">{
    ...
    "result": {
        ...
        "name": "John Doe",
        "username": "john_doe",
        "created_at_formatted": "Jun 21st, 2021 at 10:00",
...
<pre><code class="language-bash">curl -X PUT \
    "https://laraclassified.bedigit.local/api/users/dolores" \
    -H "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    -H "Content-Type: multipart/form-data" \
    -H "Accept: application/json" \
    -H "Content-Language: en" \
    ...
    -F "accept_marketing_offers=" \
    -F "time_zone=America/New_York" \
    -F "photo=@/private/var/folders/r0/k0xbnx757k3fnz09_6g9rp6w0000gn/T/phpOef05b" </code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://laraclassified.bedigit.local/api/users/dolores"
);
...
$response = $client-&gt;put(
    ...
    [
        ...
        'multipart' =&gt; [
            ...
            [
                'name' =&gt; 'photo',
                'contents' =&gt; fopen('/private/var/folders/r0/k0xbnx757k3fnz09_6g9rp6w0000gn/T/phpOef05b', 'r')
            ],
        ],
    ]
);
...
<pre><code class="language-bash">curl -X DELETE \
    "https://laraclassified.bedigit.local/api/users/unde" \
    -H "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Content-Language: en" \
...
<pre><code class="language-bash">curl -X GET \
    -G "https://laraclassified.bedigit.local/api/users/autem/verify/resend/email?entitySlug=users" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Content-Language: en" \
    -H "X-AppApiToken: Uk1DSFlVUVhIRXpHbWt6d2pIZjlPTG15akRPN2tJTUs=" \
    -H "X-AppType: docs"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://laraclassified.bedigit.local/api/users/autem/verify/resend/email"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "https://laraclassified.bedigit.local/api/users/quia/verify/resend/sms?entitySlug=users" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Content-Language: en" \
    -H "X-AppApiToken: Uk1DSFlVUVhIRXpHbWt6d2pIZjlPTG15akRPN2tJTUs=" \
    -H "X-AppType: docs"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://laraclassified.bedigit.local/api/users/quia/verify/resend/sms"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "https://laraclassified.bedigit.local/api/users/verify/molestias/voluptate?entitySlug=users" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Content-Language: en" \
    -H "X-AppApiToken: Uk1DSFlVUVhIRXpHbWt6d2pIZjlPTG15akRPN2tJTUs=" \
    -H "X-AppType: docs"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://laraclassified.bedigit.local/api/users/verify/molestias/voluptate"
);
