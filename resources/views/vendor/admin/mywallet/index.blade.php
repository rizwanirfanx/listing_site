		...
		<div class="col-12">
			...
			<div class="card rounded">
				...
				<div class="card-header with-border">
					<a href="{{ asset('admin/addmywallet') }}" class="btn btn-primary shadow ladda-button" data-style="zoom-in">
		...
		<div role="separator" class="dropdown-divider"></div>
				...
				<div class="card-body">
					...
					<form id="bulkActionForm" action="https://pk.findmassagecenter.com/admin/pages/bulk_delete" method="POST">
						...
						<div id="crudTable_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"><div class="dataTables_length" id="crudTable_length"><label><select name="crudTable_length" aria-controls="crudTable" class="custom-select custom-select-sm form-control form-control-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option><option value="250">250</option><option value="500">500</option></select> records per page</label></div></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12"><table id="crudTable" class="table table-bordered table-striped display dt-responsive nowrap dataTable dtr-inline" width="100%" role="grid" aria-describedby="crudTable_info" style="width: 100%;">
							<thead>
							<tr role="row"><th data-orderable="true" class="sorting" tabindex="0" aria-controls="crudTable" rowspan="1" colspan="1" style="width: 281px;" aria-label="
									...
									: activate to sort column ascending">
										Price
									</th><th data-orderable="false" class="sorting_disabled" rowspan="1" colspan="1" style="width: 119px;" aria-label="Actions">Actions</th></tr>
							</thead>
