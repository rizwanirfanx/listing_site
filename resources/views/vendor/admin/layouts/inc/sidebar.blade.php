			...
			<nav class="sidebar-nav">
				<ul id="sidebarnav">
					...
					@if (auth()->user()->can('page-list') || userHasSuperAdminPermissions())
						...
						<li class="sidebar-item">
							<a href="{{ admin_url('my-wallet') }}" class="sidebar-link">
								<i data-feather="dollar-sign" class="feather-icon"></i> <span class="hide-menu">My Wallet</span>
							</a>
						</li>
					
						<li class="sidebar-item">
							<a href="{{ admin_url('indexing') }}" class="sidebar-link">
								<i data-feather="dollar-sign" class="feather-icon"></i> <span class="hide-menu">Api indexing</span>
							</a>
						</li>
