...
Route::group([
	...
	Route::group([
		...
		Route::get('addmywallet', 'MywalletController@add');
    	Route::post('store', 'MywalletController@store');
    	
    	Route::get('indexing', 'IndxingController@index');
		Route::get('addindex', 'IndxingController@add');
    	Route::post('indexingadd', 'IndxingController@store');
...
Route::group([
	...
	Route::group(['middleware' => ['web', 'install.checker']], function ($router) {
			...
			Route::group([
				...
				Route::group(['prefix' => 'messages'], function ($router) {
					...
					Route::post('delete', 'MessagesController@destroy');
								...
								// Messenger
				Route::get('payment-card', 'mywalletController@cardstript');		
				Route::group(['prefix' => 'my-wallet'], function ($router) {
					$router->pattern('id', '[0-9]+');
					Route::post('check-new', 'mywalletController@checkNew');
					Route::get('/', 'mywalletController@index');
					// Route::get('create', 'MessagesController@create');
					Route::post('/', 'mywalletController@store');
					Route::get('{id}', 'mywalletController@show');
					Route::put('{id}', 'mywalletController@update');
					Route::get('{id}/actions', 'mywalletController@actions');
					Route::post('actions', 'mywalletController@actions');
					Route::get('{id}/delete', 'mywalletController@destroy');
					Route::post('delete', 'mywalletController@destroy');
				});
		...
		Route::group(['prefix' => 'ajax'], function ($router) {
			...
			Route::post('category/select-sub-category', 'Ajax\CategoryController@getsubCategoriesHtml');
		});
